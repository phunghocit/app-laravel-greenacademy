@extends('chucnang.baocao.list')
@section('header-content')
<h1>Quản lý kho hàng</h1>
@endsection
@section('main-content')
@section('child-content-khohang')
<div class="row">
                                ...
                                <table class="table table-bordered table-hover tablesorter" id="sample-table">
                                    ...
                                    @foreach ($data as $item)
                                        ...
                                        <tr align="right">
                                            ...
                                            <td>{!! $val->sl_xuat !!}</td>
                                            <td>{!! $val->sl_ton !!}</td>
                                            <td align="right">{!! number_format($val->vt_gia,2)  !!}</td>
                                            <td align="right">{!! number_format($val->vt_gia*$val->sl_ton,2)  !!}</td>
                                        </tr>
                                          @endforeach  
                                        @endforeach
